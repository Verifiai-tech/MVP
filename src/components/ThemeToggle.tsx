...
export function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={toggleTheme}
      className="rounded-xl p-2 text-surface-500 hover:bg-surface-100/90 hover:text-surface-800 dark:text-surface-400 dark:hover:bg-surface-800 dark:hover:text-surface-100 transition-colors"
